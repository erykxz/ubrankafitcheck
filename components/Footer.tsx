...
const REMIX_SUGGESTIONS = [
  "Pomysł na remix: Wygeneruj lookbook do udostępnienia.",
  "Pomysł na remix: Zintegruj API e-commerce, aby znaleźć podobne produkty.",
  "Pomysł na remix: Dodaj akcesoria, takie jak kapelusze, okulary lub torebki.",
  "Pomysł na remix: Stwórz 'ocenę stylu' dla strojów.",
  "Pomysł na remix: Pozwól użytkownikom zapisywać ulubione stroje.",
  "Pomysł na remix: Generuj różne wersje kolorystyczne ubrań.",
];
